...
function showAdminPictureForm() {
	document.getElementById('overlayBg').classList.add('active');
    document.getElementById('adminPictureForm').classList.add('active');
}

function hideAdminPictureForm() {
    document.getElementById('overlayBg').classList.remove('active');
    document.getElementById('adminPictureForm').classList.remove('active');
}
...
document.addEventListener("DOMContentLoaded", () => {
    const formFields = document.querySelectorAll('#admin-picture-form input');
    const form = document.getElementById('admin-picture-form');
