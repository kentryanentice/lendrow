$(document).ready(function () {
    ...
    function loadLendingTermsData() {
        Promise.all([
            $.ajax({
            url: 'functions/load-admin-borrowers-lending-terms-card.php',
            type: 'GET',
            cache: false
        }),])
...
$(document).ready(function () {
    ...
    function loadLendingInfo() {
        ...
        $.ajax({
            url: 'functions/load-admin-borrowers-lending-info.php',
            type: 'GET',
            cache: false,
...
function showLenderForm() {
	...
	document.getElementById('adminLenderForm').classList.add('active');
	document.getElementById('applicationManagerButton').classList.remove('active');
	document.getElementById('adminApplicationManager').classList.remove('active');
}
...
function showApplicationManager() {
	...
	document.getElementById('adminLenderForm').classList.remove('active');
	document.getElementById('applicationManagerButton').classList.add('active');
	document.getElementById('adminApplicationManager').classList.add('active');
}
...
$(document).ready(function () {
    function loadAdminBorrowersApplicationCard() {
        ...
        $.ajax({
            url: 'functions/load-admin-borrowers-application-card.php',
            type: 'GET',
            cache: false,
            success: function (response) {
                if (response.includes('<html') || response.includes('<!DOCTYPE')) {
    ...
    loadAdminBorrowersApplicationCard();

    setInterval(loadAdminBorrowersApplicationCard, 90000);
});
...
$(document).ready(function () {
    function loadApplicationHistory() {
        $.ajax({
            url: 'functions/load-admin-borrowers-application-history.php',
            type: 'GET',
            cache: false,
            success: function (response) {
                if (response.includes('<html') || response.includes('<!DOCTYPE')) {
...
$(document).ready(function () {
    ...
    function loadLendingTermsApplicationCard() {
        ...
        $.ajax({
            url: 'functions/load-admin-borrowers-lending-terms-applications-card.php',
            type: 'GET',
            cache: false,
            success: function (response) {
                if (response.includes('<html') || response.includes('<!DOCTYPE')) {
