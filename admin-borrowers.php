...
<html lang="en">
<head>
	<title>Prime LendRow Admin Borrowers</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="icon" href="pictures/logo.png" type="image/x-icon">
	<link rel="stylesheet" type="text/css" href="css/admin-borrowers.css">
...
<div class="admin-borrowers-content">
	...
	<div class="admin-borrowers-form">
	
		<div class="admin-borrowers-buttons">
		...
		<div class="admin-lenders active" id="adminLenderForm">
		...
		<div class="admin-application-manager" id="adminApplicationManager">
				...
				<div class="application-manager-card-image-content">
					<span class="application-manager-card-overlay"></span>
						...
						<div class="application-manager-borrowername"> 
							<?php echo htmlspecialchars($admin['firstname']); ?> <?php echo htmlspecialchars($admin['middlename']); ?> <?php echo htmlspecialchars($admin['lastname']); ?>
						</div>
				</div>
					...
					<div class="application-manager-card-content">
						...
						<div class="application-manager-card-details">
							<label>Mobile No: </label><input type="text" placeholder="Mobile No." value="<?php echo htmlspecialchars($admin['mobile']); ?>" readonly>
						</div>
		...
		<div id="lendingTermsApplicationCardContainer">
			...
			<div class="admin-borrowers-error">
				<?php
					if(isset($_GET["error"])) {
	...
	<div class="admin-borrowers-wallet">
	...
	<script src="js/admin-borrowers.js"></script>
</body>
