...
<html lang="en">
<head>
	<title>Prime LendRow Admin Payments</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="icon" href="pictures/logo.png" type="image/x-icon">
	<link rel="stylesheet" type="text/css" href="css/admin-payments.css">
...
<div class="admin-payments-content">
	...
	<div class="admin-payments-form">
		<div class="admin-payments-buttons">
			<div class="payments-manager-button active" id="paymentsManagerButton" onclick="showPaymentsManager()"><div id="adminPaymentsManagerNotification"></div>Payments</div>
			<div class="collect-manager-button" id="collectManagerButton" onclick="showCollectManager()">Collections</div>
			
		</div>
	
		<div class="admin-payment-manager active" id="adminPaymentManager">
		...
		<div class="admin-collect-manager" id="adminCollectManager">
	...
	<div class="admin-payments-wallet">
		...
		<div class="admin-payments-error">
				<?php
					if(isset($_GET["error"])) {
