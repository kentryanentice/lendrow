...
function approve($connection, $userId, $decodedLenderName, $decodedBorrowerName, $decodedMobile, $decodedAmount, $decodedInterest, $decodedTerm, $decodedMonthly, $decodedCollateral, $decodedLendingTermsId, $decodedApplicationsId, $decodedApplicationsUsersId) {
	...
	mysqli_stmt_bind_param($stmtLending, "ii",  $decodedLendingTermsId, $userId);
...
function disburse($connection, $userId, $decodedPicture, $decodedLenderName, $decodedBorrowerName, $decodedMobile, $decodedAmount, $decodedInterest, $decodedTerm, $decodedMonthly, $decodedCollateral, $decodedLendingTermsId, $decodedApplicationsId, $decodedApplicationsUsersId, $decodedAgreementsId) {
	...
	$senderWalletId = getSenderWalletId($connection, $decodedLenderName, $userId);
    ...
    mysqli_stmt_bind_param($stmtInsert, "sssssii", $decodedLenderName, $decodedMobile, $decodedAmount, $decodedBorrowerName,  $transferMethod, $decodedApplicationsUsersId, $userId);
...
function getSenderWalletId($connection, $decodedLenderName, $userId) {
    ...
    mysqli_stmt_bind_param($stmt, "si", $decodedLenderName, $userId);
    mysqli_stmt_execute($stmt);
