...
include '../php/borrowers-lending-terms-functions.php';
		...
		?>
			...
			<h2>Lending Terms</h2>
			<form action="php/borrowers-borrow" id="user-borrow" method="POST" enctype="multipart/form-data">
			
			<input type="hidden" name="lending-terms-id" value="<?php echo htmlspecialchars($lender['id']); ?>" readonly>
			
			<div class="agreement">
			<p>The terms below is effective as of <span class="blue-text"><?php echo htmlspecialchars(date("F d, Y h:i A", strtotime($lender['created_at']))); ?></span>. This will serve as a proof that I, <span class="blue-text"><?php echo htmlspecialchars($user['firstname']); ?> <?php echo htmlspecialchars($user['middlename']); ?> <?php echo htmlspecialchars($user['lastname']); ?></span> will be borrowing an amount of <span class="blue-text">PHP <?php echo htmlspecialchars($lender['amount']); ?></span> with a <span class="blue-text"><?php echo htmlspecialchars($lender['interest']); ?></span> Interest from <span class="blue-text"><?php echo htmlspecialchars($lender['lendername']); ?></span>, which to be paid within <span class="blue-text"><?php echo htmlspecialchars($lender['term']); ?></span>, a monthly interest rate of <span class="blue-text">PHP <?php echo htmlspecialchars($lender['monthly']); ?></span> and fully disclose my <span class="blue-text">credit history.</span></p>
