function showPaymentsManager() {
	...
	document.getElementById('adminPaymentManager').classList.add('active');
	...
	document.getElementById('adminCollectManager').classList.remove('active');
...
function showCollectManager() {
	...
	document.getElementById('adminPaymentManager').classList.remove('active');
	...
	document.getElementById('adminCollectManager').classList.add('active');
...
$(document).ready(function () {
    ...
    function loadPaymentsData() {
        ...
        Promise.all([$.ajax({ url: 'functions/load-admin-payments-payment-card.php', type: 'GET', cache: false })])
...
$(document).ready(function () {
    ...
    function loadCollectionsData() {
        ...
        Promise.all([$.ajax({
            url: 'functions/load-admin-payments-collection-card.php',
            type: 'GET',
            cache: false
        })])
        .then(function (response) {
...
$(document).ready(function () {
    ...
    function loadMonthlyPaymentCards() {
        ...
        $.ajax({
            url: 'functions/load-admin-payments-monthly-payment-card.php',
            type: 'GET',
            cache: false,
    ...
    function loadAdminPaymentsNotification() {
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#adminPaymentsManagerNotification').html(response);
            },
            error: function () {
                $('#adminPaymentsManagerNotification').html('<p class="error-message"></p>');
            }
        });
    }
...
$(document).ready(function () {
    ...
    function loadPaymentInfo() {
        ...
        $.ajax({
            url: 'functions/load-admin-payments-payment-info.php',
            type: 'GET',
            cache: false,
            success: function (response) {
                if (response.includes('<html') || response.includes('<!DOCTYPE')) {
...
$(document).ready(function () {
    ...
    function loadCollectionInfo() {
        ...
        $.ajax({
            url: 'functions/load-admin-payments-collection-info.php',
            type: 'GET',
            cache: false,
            success: function (response) {
                if (response.includes('<html') || response.includes('<!DOCTYPE')) {
